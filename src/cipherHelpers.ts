...
const decodeAesGcm = (deriveSharedKey: (privateKey: Uint8Array, recipientPublicKey: Uint8Array) => Uint8Array, privateKey: Uint8Array, recipientPublicKey: Uint8Array, encodedMessage: Uint8Array) => {
...
const encodeAesGcm = (deriveSharedKey: (privateKey: Uint8Array, recipientPublicKey: Uint8Array) => 
	Uint8Array, privateKey: Uint8Array, recipientPublicKey: Uint8Array, message: Uint8Array, iv: Uint8Array | undefined = undefined) => {
	const sharedKey = deriveSharedKey(privateKey, recipientPublicKey);
	const cipher = new AesGcmCipher(sharedKey);
