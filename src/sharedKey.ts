 ...
 */
const deriveSharedSecretFactory = (cryptoHash: (output: Uint8Array, input: Uint8Array, inputLen?: number) => void): ((privateKey: Uint8Array, publicKey: Uint8Array) => Uint8Array) => (privateKey, otherPublicKey) => {
 ...
 */
const deriveSharedKeyFactory = (info: string, cryptoHash: (output: Uint8Array, input: Uint8Array, inputLen?: number) => void): ((privateKey: Uint8Array, otherPublicKey: Uint8Array) => Uint8Array) => {
 ...
 */
const deriveSharedKey = (privateKey: Uint8Array, otherPublicKey: Uint8Array): Uint8Array => deriveSharedKeyImpl(privateKey, otherPublicKey);
